sap.ui.define([
		...
		return BaseController.extend("opensapmanageproducts.controller.Worklist", {
			...
			onDeletePressed: function(oEvent){
				...
				this.getModel().remove(sPath, {
					success: this._onDeletedSuccess(objectName)
				});
				
				//console.log(oEvent.getSource().getBindingContext());
			},
			
			_onDeletedSuccess: function(objectName){
				// show success messge
				var sMessage = this.getResourceBundle().getText("ObjectDeleted", [objectName]);
			...
			_getPopover : function () {
				...
				if (!this._oPopover) {
					...
					"opensapmanageproducts.view.ResponsivePopover", this);
				}
