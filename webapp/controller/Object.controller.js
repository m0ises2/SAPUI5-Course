...
sap.ui.define([
		...
		return BaseController.extend("opensapmanageproducts.controller.Object", {
			...
			// create dialog lazily
				if (!this._oPopover) {
					...
					this._oPopover = sap.ui.xmlfragment("opensapmanageproducts.view.ResponsivePopover", this);
				}
