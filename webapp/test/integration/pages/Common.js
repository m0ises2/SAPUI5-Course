sap.ui.define([
		...
		function getFrameUrl (sHash, sUrlParameters) {
			var sUrl = jQuery.sap.getResourcePath("opensapmanageproducts/app", ".html");
		...
		return Opa5.extend("opensapmanageproducts.test.integration.pages.Common", {
			...
			getMockServer : function () {
				return new Promise(function (success) {
					Opa5.getWindow().sap.ui.require(["opensapmanageproducts/localService/mockserver"], function (mockserver) {
